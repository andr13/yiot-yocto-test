...
PROJECT_BRANCH="${PROJECT_BRANCH:-v5.2.1}"
...
######################################################################
export PACKAGE_NAME=${PACKAGE_NAME:-"python-virgil-sdk"}
...
GET_SOURCE0="git clone --branch ${PROJECT_BRANCH} --single-branch https://github.com/VirgilSecurity/virgil-sdk-python.git"
